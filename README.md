...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/dash-labs-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12991&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/dash-labs-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `dash-labs` can be installed with:

```
conda install dash-labs
```

It is possible to list all of the versions of `dash-labs` available on your platform with:
